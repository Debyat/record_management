			...
			<div class = "panel-body">
				...
				<table id = "table" class = "display" width = "100%" cellspacing = "0">
					...
					<?php
						...
						$f = $q->fetch_array();
						$med = $conn->query("SELECT COUNT(*) as total FROM `medication` where `itr_id` = '$id'") or die(mysqli_error());
						$med = $med->fetch_array();
					?>
						<tr>
							...
							<td>
								<center>
								<a href = "medication.php?id=<?php echo $fetch['itr_no']?>" class = "btn btn-sm btn-info medication">
									Medication<span class = "badge"><?php echo $med['total']?></span>
								</a> 
								<a href = "complaints.php?id=<?php echo $fetch['itr_no']?>&lastname=<?php echo $fetch['lastname']?>" class = "btn btn-sm btn-info complaints">
									Complaints <span class = "badge"><?php echo $f['total']?></span></a> 
								<a href = "edit_patient.php?id=<?php echo $fetch['itr_no']?>&lastname=<?php echo $fetch['lastname']?>" class = "btn btn-sm btn-warning">
