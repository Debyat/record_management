...
VALUES (NULL, 'Effavescent tablet'),
(NULL, 'Chewable tablet'),
(NULL, 'Sublingual tablet'),
(NULL, 'Enteric coated tablet'),
(NULL, 'Capsule'),
(NULL, 'Powder'),
(NULL, 'Lozenges'),
(NULL, 'Mixtures'),
(NULL, 'Implant'),
(NULL, 'Irrigation solution'),
(NULL, 'Lotion'),
(NULL, 'Gargle'),
(NULL, 'Drops'),
(NULL, 'Ointment'),
(NULL, 'Cream'),
(NULL, 'Ointment'),
(NULL, 'Intramuscular injection'),
(NULL, 'IntSubcutaneous injection'),
(NULL, 'Intravenous injection'),
(NULL, 'Suppository'),
(NULL, 'Transdermal patch'),
(NULL, 'Inhaler'),
(NULL, 'Pessary'),
(NULL, 'Enema');